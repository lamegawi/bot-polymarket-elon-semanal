...
ESTADO = "real_semanal.json"
HISTORIAL = "resultados_real_semanal.csv"
BANKROLL = 500.0
...
def probar_orden():
    ...
    try:
        ...
        return
    activo = next((m for m in mercados if not m["cerrado"] and m["tipo"] == "semanal"), None)
    if not activo:
